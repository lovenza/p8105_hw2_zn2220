...
```
    ...
    ## Warning in left_join(zori_tidy, zip_info_tidy, by = "zip_code"): Detected an unexpected many-to-many relationship between `x` and `y`.
...
includes a total of 17516 observations. It covers 149 unique ZIP codes
and 43 unique neighborhoods across the five boroughs. Key variables
include zip_code, county, neighborhood, date, and the rental index zori.
Specifically:
